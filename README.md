...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/workshop-demo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15159&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/workshop-demo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `workshop-demo` can be installed with:

```
conda install workshop-demo
```

It is possible to list all of the versions of `workshop-demo` available on your platform with:
